...
export const assignConductorInspector = async (
  conductorId,
  inspectorId,
  inspectionPointId
) => {
  try {
    const response = await axios.post("http://localhost:5001/assignments", {
    ...
    console.error(
      "Error assigning conductor, inspector, and inspection point:",
      error.message
    );
    throw error;
  }
...
export const fetchInspectors = async () => {
  try {
    const response = await axios.get("http://localhost:5001/inspectors");
    return response.data;
  } catch (error) {
...
export const fetchInspectionPoints = async () => {
  try {
    const response = await axios.get("http://localhost:5001/inspection-points");
    return response.data;
  } catch (error) {
...
export const addInspector = async (name) => {
  try {
    const response = await axios.post("http://localhost:5001/inspectors", {
      name,
    });
    return response.data;
  } catch (error) {
...
export const removeInspector = async (inspectorId) => {
  try {
    const response = await axios.delete(
      `http://localhost:5001/inspectors/${inspectorId}`
    );
    return response.data;
  } catch (error) {
...
export const addInspectionPoint = async (name) => {
  try {
    const response = await axios.post(
      "http://localhost:5001/inspection-points",
      { name }
    );
    return response.data;
  } catch (error) {
...
export const removeInspectionPoint = async (inspectionPointId) => {
  try {
    const response = await axios.delete(
      `http://localhost:5001/inspection-points/${inspectionPointId}`
    );
    return response.data;
  } catch (error) {
